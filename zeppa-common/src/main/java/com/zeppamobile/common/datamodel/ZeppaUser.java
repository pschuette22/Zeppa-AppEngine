...
public class ZeppaUser {
	 ...
	 * 
	 * 
	 * Devices represent devices used to login to this account
	 * These are how we notify the user of updates to the database
	 */
	 ...
	 */
	public boolean addEventRelationship(ZeppaEventToUserRelationship relationship){
	 ...
	 */
	public boolean removeEventRelationship(ZeppaEventToUserRelationship relationship){
	 ...
	 * @return true if relationship was added successfully 
	 */
	public boolean addCreatedRealtionship(ZeppaUserToUserRelationship relationship){
	 ...
	 * @return true if Event Relationship was successfully removed
	 */
	public boolean removeCreatedRelationship(ZeppaUserToUserRelationship relationship){
	 ...
	 */
	public boolean addSubjectRelationship(ZeppaUserToUserRelationship relationship){
	 ...
	 * @return
	 */
	public boolean removeSubjectRelationship(ZeppaUserToUserRelationship relationship){
	 ...
	 * @return true if relationship was removed
	 */
	public boolean removeUserRelationship(ZeppaUserToUserRelationship relationship){
