<%@tag language="java" description="Right Side Bar Page template" pageEncoding="UTF-8"%>
									...
									<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li class="current_page_item"><a href="template/right-sidebar.html">Right Sidebar</a></li>
