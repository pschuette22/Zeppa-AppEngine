...
{	
	...
	public IWord[] getClosestSenses(String w1, POS tag1, String w2, POS tag2, LKB lkb, SignatureComparison measure, int size)
	{
		double maxSim = 0;
		IWord src = null;
		IWord trg = null;
		IWord[] result = new IWord[2];
