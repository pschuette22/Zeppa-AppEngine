...
public class StanfordTokenizer {
	...
	private static final String[] OLDSTRINGS = { "\\(", "\\)", "\\[", "\\]", "\\{", "\\}", "\\*", "/", "_", "-" };
	private static final String[] NEWSTRING = { "-LRB-", "-RRB-", "-LCB-", "-RCB-", "-LCB-", "-RCB-", "\\*", "\\/", "-",
			" " };
	...
	public List<Word> tokenize(String string) {
		this.tokenizer = new PTBTokenizer<Word>(new StringReader(string), new WordTokenFactory(),
